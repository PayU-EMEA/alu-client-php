...
require_once dirname(__FILE__) . '/PayU/PaymentsApi/AluV3/Services/HashService.php';
require_once dirname(__FILE__) . '/PayU/PaymentsApi/AluV3/Services/HTTPClient.php';
